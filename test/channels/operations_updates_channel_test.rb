...
class OperationsUpdatesChannelTest < ActionCable::Channel::TestCase
  ...
  test "administrator receives shared updates and personal access revocation" do
    ...
    subscribe signed_stream_name: Turbo::StreamsChannel.signed_stream_name(Realtime::OperationsUpdates::STREAM)
    assert subscription.confirmed?
    assert_has_stream Realtime::OperationsUpdates::STREAM
    assert_has_stream Realtime::OperationsUpdates.access_stream(users(:admin).id)
  end
