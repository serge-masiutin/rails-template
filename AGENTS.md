...
- Сохраняй оригинальные имена инструментов, протоколов, API и технических сущностей в UI и документации. Названия и правила употребления trace/span, Solid Queue и служебных панелей — в `clear-writing`; обычные действия и пояснения пиши по-русски.
