---
name: good-readme
description: 'Write or improve a README.md for an open source project. Use this for any request to create, rewrite, review, or polish a README, project description, or "getting started" docs for a library, framework, or tool, or to make an open source project more popular or attractive to users. Use for the StarterApp README as described below; otherwise do NOT use for internal/private repo docs, API reference generation, or CHANGELOG/CONTRIBUTING files.'
---

## Project Context

- Also apply this skill to the StarterApp README. Keep project documentation in Russian; preserve these skill instructions in English.
- Keep README focused on purpose, setup, checks, and navigation. Update existing topic documents in `docs/` instead of duplicating them; use `clear-writing` for the final prose.
- Derive commands and claims from the repository and actual checks. Open-source marketing examples below do not establish StarterApp benchmarks or require publishing the project.
