...
- Обычные действия и пояснения пиши по-русски: «Войти», «Обновить», «очередь задач», «метрики», «логи». В продуктовом UI объясняй действие без внутренних терминов, если они не помогают пользователю.
