...
- Интерфейс и письма пока только на английском: “Sign in”, “Refresh”, “Metrics and logs”. Храни собственные тексты в Rails i18n; язык документации, комментариев и общения — русский. В продуктовом UI объясняй действие без внутренних терминов, если они не помогают пользователю.
